...
public class OperationCallEvent extends AbstractMonitoringRecord {
    ...
    public static final Class<?>[] TYPES = { String.class, // OperationCallEvent.sourceComponent
    ...
    /** property name array. */
    public static final String[] VALUE_NAMES = { "sourceComponent", "sourceOperation", "targetComponent",
            "targetOperation", };
     ...
     *            targetOperation
     */
    public OperationCallEvent(final String sourceComponent, final String sourceOperation, final String targetComponent,
