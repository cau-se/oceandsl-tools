 ...
 * @since 1.3.0
 */
public class CreateDataflowTableStage extends AbstractTransformation<FortranProject, Table> {
    ...
    protected void execute(final FortranProject project) throws Exception {
        final Table callsTable = new Table("calls", new StringValueHandler(CreateDataflowTableStage.SOURCE_PATH),
