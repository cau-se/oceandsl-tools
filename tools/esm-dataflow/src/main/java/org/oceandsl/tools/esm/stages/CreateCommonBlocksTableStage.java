 ...
 * @since 1.3.0
 */
public class CreateCommonBlocksTableStage extends AbstractTransformation<FortranProject, Table> {

    // TODO does not create common blocks table
    ...
    protected void execute(final FortranProject project) throws Exception {
        final Table callsTable = new Table("calls", new StringValueHandler(CreateCommonBlocksTableStage.SOURCE_PATH),
                new StringValueHandler(CreateCommonBlocksTableStage.SOURCE_MODULE),
                new StringValueHandler(CreateCommonBlocksTableStage.SOURCE_OPERATION),
                new StringValueHandler(CreateCommonBlocksTableStage.TARGET_PATH),
                new StringValueHandler(CreateCommonBlocksTableStage.TARGET_MODULE),
                new StringValueHandler(CreateCommonBlocksTableStage.TARGET_OPERATION));
