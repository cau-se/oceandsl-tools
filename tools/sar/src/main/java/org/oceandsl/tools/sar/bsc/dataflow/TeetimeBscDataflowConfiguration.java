...
public class TeetimeBscDataflowConfiguration extends Configuration {
    ...
    public TeetimeBscDataflowConfiguration(Logger logger, Settings settings, ModelRepository modelRepository) throws IOException, ValueConversionErrorException {
        ...
        final DeploymentModelStage deploymentModelStage = new DeploymentModelStage(modelRepository.getModel(AssemblyModel.class), modelRepository.getModel(DeploymentModel.class), modelRepository.getModel(SourceModel.class), settings.getSourceLabel());
