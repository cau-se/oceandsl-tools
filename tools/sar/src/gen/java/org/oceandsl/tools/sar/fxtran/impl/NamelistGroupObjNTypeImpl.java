...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Namelist Group Obj NType</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class NamelistGroupObjNTypeImpl extends MinimalEObjectImpl.Container implements NamelistGroupObjNType {
    ...
    public NotificationChain basicSetN(NType newN, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FxtranPackage.NAMELIST_GROUP_OBJ_NTYPE__N, oldN, newN);
    ...
    public void setN(NType newN) {
        if (newN != n) {
            ...
            if (n != null)
                msgs = ((InternalEObject)n).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FxtranPackage.NAMELIST_GROUP_OBJ_NTYPE__N, null, msgs);
            if (newN != null)
                msgs = ((InternalEObject)newN).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FxtranPackage.NAMELIST_GROUP_OBJ_NTYPE__N, null, msgs);
            msgs = basicSetN(newN, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.NAMELIST_GROUP_OBJ_NTYPE__N, newN, newN));
    }
