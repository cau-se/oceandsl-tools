...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Open Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.oceandsl.tools.sar.fxtran.impl.OpenStmtTypeImpl#getConnectSpecSpec <em>Connect Spec Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpenStmtTypeImpl extends MinimalEObjectImpl.Container implements OpenStmtType {
    ...
    public FeatureMap getMixed() {
        if (mixed == null) {
            mixed = new BasicFeatureMap(this, FxtranPackage.OPEN_STMT_TYPE__MIXED);
        }
        return mixed;
    }
    ...
    public FeatureMap getGroup() {
        return (FeatureMap)getMixed().<FeatureMap.Entry>list(FxtranPackage.eINSTANCE.getOpenStmtType_Group());
    }
    ...
    public EList<String> getCnt() {
        return getGroup().list(FxtranPackage.eINSTANCE.getOpenStmtType_Cnt());
    }
    ...
    public EList<ConnectSpecSpecType> getConnectSpecSpec() {
        return getGroup().list(FxtranPackage.eINSTANCE.getOpenStmtType_ConnectSpecSpec());
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case FxtranPackage.OPEN_STMT_TYPE__CONNECT_SPEC_SPEC:
                return ((InternalEList<?>)getConnectSpecSpec()).basicRemove(otherEnd, msgs);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case FxtranPackage.OPEN_STMT_TYPE__CNT:
                ...
                return;
            case FxtranPackage.OPEN_STMT_TYPE__CONNECT_SPEC_SPEC:
                getConnectSpecSpec().clear();
                getConnectSpecSpec().addAll((Collection<? extends ConnectSpecSpecType>)newValue);
                return;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case FxtranPackage.OPEN_STMT_TYPE__CONNECT_SPEC_SPEC:
                return !getConnectSpecSpec().isEmpty();
        }
