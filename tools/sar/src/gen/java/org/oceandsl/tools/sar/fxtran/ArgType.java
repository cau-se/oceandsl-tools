 ...
 *   <li>{@link org.oceandsl.tools.sar.fxtran.ArgType#getArrayConstructorE <em>Array Constructor E</em>}</li>
...
public interface ArgType extends EObject {
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='array-constructor-E' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='parens-E' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='string-E' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
