...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Close Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.oceandsl.tools.sar.fxtran.impl.CloseStmtTypeImpl#getCloseSpecSpec <em>Close Spec Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CloseStmtTypeImpl extends MinimalEObjectImpl.Container implements CloseStmtType {
    ...
    public FeatureMap getMixed() {
        if (mixed == null) {
            mixed = new BasicFeatureMap(this, FxtranPackage.CLOSE_STMT_TYPE__MIXED);
        }
        return mixed;
    }
    ...
    public EList<CloseSpecSpecType> getCloseSpecSpec() {
        return getMixed().list(FxtranPackage.eINSTANCE.getCloseStmtType_CloseSpecSpec());
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case FxtranPackage.CLOSE_STMT_TYPE__CLOSE_SPEC_SPEC:
                return ((InternalEList<?>)getCloseSpecSpec()).basicRemove(otherEnd, msgs);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case FxtranPackage.CLOSE_STMT_TYPE__MIXED:
                ...
                return;
            case FxtranPackage.CLOSE_STMT_TYPE__CLOSE_SPEC_SPEC:
                getCloseSpecSpec().clear();
                getCloseSpecSpec().addAll((Collection<? extends CloseSpecSpecType>)newValue);
                return;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case FxtranPackage.CLOSE_STMT_TYPE__CLOSE_SPEC_SPEC:
                return !getCloseSpecSpec().isEmpty();
        }
