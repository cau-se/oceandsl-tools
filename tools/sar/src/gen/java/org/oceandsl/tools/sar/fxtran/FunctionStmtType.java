...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Function Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 *   <li>{@link org.oceandsl.tools.sar.fxtran.FunctionStmtType#getDerivedTSpec <em>Derived TSpec</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.FunctionStmtType#getDummyArgLT <em>Dummy Arg LT</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.FunctionStmtType#getFunctionN <em>Function N</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.FunctionStmtType#getIntrinsicTSpec <em>Intrinsic TSpec</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.FunctionStmtType#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.FunctionStmtType#getResultSpec <em>Result Spec</em>}</li>
 * </ul>
 *
...
public interface FunctionStmtType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Derived TSpec</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.DerivedTSpecType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     *        extendedMetaData="kind='element' name='derived-T-spec' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
    EList<DerivedTSpecType> getDerivedTSpec();

    /**
     * Returns the value of the '<em><b>Dummy Arg LT</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.DummyArgLTType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='dummy-arg-LT' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
    EList<DummyArgLTType> getDummyArgLT();

    /**
     * Returns the value of the '<em><b>Function N</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.FunctionNType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='function-N' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
    EList<FunctionNType> getFunctionN();

    /**
     * Returns the value of the '<em><b>Intrinsic TSpec</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.IntrinsicTSpecType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='intrinsic-T-spec' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Result Spec</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.ResultSpecType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='result-spec' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
