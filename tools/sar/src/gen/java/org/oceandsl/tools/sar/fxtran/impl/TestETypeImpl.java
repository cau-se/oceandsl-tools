...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Test EType</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class TestETypeImpl extends MinimalEObjectImpl.Container implements TestEType {
    ...
    public NotificationChain basicSetNamedE(NamedEType newNamedE, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FxtranPackage.TEST_ETYPE__NAMED_E, oldNamedE, newNamedE);
    ...
    public void setNamedE(NamedEType newNamedE) {
        if (newNamedE != namedE) {
            ...
            if (namedE != null)
                msgs = ((InternalEObject)namedE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FxtranPackage.TEST_ETYPE__NAMED_E, null, msgs);
            if (newNamedE != null)
                msgs = ((InternalEObject)newNamedE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FxtranPackage.TEST_ETYPE__NAMED_E, null, msgs);
            msgs = basicSetNamedE(newNamedE, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.TEST_ETYPE__NAMED_E, newNamedE, newNamedE));
    }
    ...
    public NotificationChain basicSetOpE(OpEType newOpE, NotificationChain msgs) {
        ...
        opE = newOpE;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FxtranPackage.TEST_ETYPE__OP_E, oldOpE, newOpE);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setOpE(OpEType newOpE) {
        if (newOpE != opE) {
            NotificationChain msgs = null;
            if (opE != null)
                msgs = ((InternalEObject)opE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FxtranPackage.TEST_ETYPE__OP_E, null, msgs);
            if (newOpE != null)
                msgs = ((InternalEObject)newOpE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FxtranPackage.TEST_ETYPE__OP_E, null, msgs);
            msgs = basicSetOpE(newOpE, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.TEST_ETYPE__OP_E, newOpE, newOpE));
    }
