...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Decl Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.impl.ComponentDeclStmtTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.impl.ComponentDeclStmtTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.impl.ComponentDeclStmtTypeImpl#getENDeclLT <em>EN Decl LT</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.impl.ComponentDeclStmtTypeImpl#getTSpec <em>TSpec</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.impl.ComponentDeclStmtTypeImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentDeclStmtTypeImpl extends MinimalEObjectImpl.Container implements ComponentDeclStmtType {
    ...
    public FeatureMap getMixed() {
        if (mixed == null) {
            mixed = new BasicFeatureMap(this, FxtranPackage.COMPONENT_DECL_STMT_TYPE__MIXED);
        }
        return mixed;
    }
    ...
    public FeatureMap getGroup() {
        return (FeatureMap)getMixed().<FeatureMap.Entry>list(FxtranPackage.eINSTANCE.getComponentDeclStmtType_Group());
    }
    ...
    public EList<ENDeclLTType> getENDeclLT() {
        return getGroup().list(FxtranPackage.eINSTANCE.getComponentDeclStmtType_ENDeclLT());
    }
    ...
    public EList<TSpecType> getTSpec() {
        return getGroup().list(FxtranPackage.eINSTANCE.getComponentDeclStmtType_TSpec());
    }
    ...
    public EList<AttributeType> getAttribute() {
        return getGroup().list(FxtranPackage.eINSTANCE.getComponentDeclStmtType_Attribute());
    }
