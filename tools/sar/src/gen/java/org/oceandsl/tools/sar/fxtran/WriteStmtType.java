...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Write Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 *   <li>{@link org.oceandsl.tools.sar.fxtran.WriteStmtType#getIoControlSpec <em>Io Control Spec</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.WriteStmtType#getOutputItemLT <em>Output Item LT</em>}</li>
 * </ul>
 *
...
public interface WriteStmtType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Io Control Spec</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.IoControlSpecType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     *        extendedMetaData="kind='element' name='io-control-spec' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
    EList<IoControlSpecType> getIoControlSpec();

    /**
     * Returns the value of the '<em><b>Output Item LT</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.OutputItemLTType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='output-item-LT' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
