...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Named EType</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface NamedEType extends EObject {
     ...
     *        extendedMetaData="kind='element' name='N' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
    EList<NType> getN();

    /**
     * Returns the value of the '<em><b>RLT</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.RLTType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='R-LT' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
