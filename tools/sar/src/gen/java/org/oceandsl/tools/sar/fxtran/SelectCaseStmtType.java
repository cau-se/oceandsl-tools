...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Select Case Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface SelectCaseStmtType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Case E</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.CaseEType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='case-E' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
