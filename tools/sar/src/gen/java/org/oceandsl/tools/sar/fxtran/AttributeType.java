...
public interface AttributeType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Attribute N</b></em>' attribute list.
     ...
     *        extendedMetaData="kind='element' name='attribute-N' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
    EList<String> getAttributeN();

    /**
     * Returns the value of the '<em><b>Intent Spec</b></em>' attribute list.
     * The list contents are of type {@link java.lang.String}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.NCName" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='intent-spec' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
