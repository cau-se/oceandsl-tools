 ...
 * </p>
 * <ul>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.VType#getNamedE <em>Named E</em>}</li>
 * </ul>
 *
 * @see org.oceandsl.tools.sar.fxtran.FxtranPackage#getVType()
 * @model extendedMetaData="name='V_._type' kind='elementOnly'"
 * @generated
 */
public interface VType extends EObject {
     ...
     * @see org.oceandsl.tools.sar.fxtran.FxtranPackage#getVType_NamedE()
    ...
    /**
     * Sets the value of the '{@link org.oceandsl.tools.sar.fxtran.VType#getNamedE <em>Named E</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
