...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Op EType</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface OpEType extends EObject {
     ...
     *        extendedMetaData="kind='element' name='cnt' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
    EList<String> getCnt();
     ...
     *        extendedMetaData="kind='element' name='literal-E' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='named-E' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
     ...
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.OpType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the value of the '<em>Op</em>' containment reference list.
     * @see org.oceandsl.tools.sar.fxtran.FxtranPackage#getOpEType_Op()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='op' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
    EList<OpType> getOp();
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='op-E' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
    EList<OpEType> getOpE();

    /**
     * Returns the value of the '<em><b>Parens E</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.ParensEType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='parens-E' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
    EList<ParensEType> getParensE();

    /**
     * Returns the value of the '<em><b>String E</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.StringEType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='string-E' namespace='##targetNamespace' group='#group:0'"
     * @generated
     */
