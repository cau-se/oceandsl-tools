...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>NType</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface NType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>N1</b></em>' attribute list.
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='op' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
    EList<OpType> getOp();
