...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Subroutine Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 *   <li>{@link org.oceandsl.tools.sar.fxtran.SubroutineStmtType#getDummyArgLT <em>Dummy Arg LT</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.SubroutineStmtType#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link org.oceandsl.tools.sar.fxtran.SubroutineStmtType#getSubroutineN <em>Subroutine N</em>}</li>
 * </ul>
 *
...
public interface SubroutineStmtType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Subroutine N</b></em>' containment reference list.
     * The list contents are of type {@link org.oceandsl.tools.sar.fxtran.SubroutineNType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData="kind='element' name='subroutine-N' namespace='##targetNamespace' group='#group:1'"
     * @generated
     */
