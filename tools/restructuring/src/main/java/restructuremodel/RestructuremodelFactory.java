...
public interface RestructuremodelFactory extends EFactory {
	 ...
	 * @generated
	 */
	RestructuremodelFactory eINSTANCE = restructuremodel.impl.RestructuremodelFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Components Transformation</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Components Transformation</em>'.
	 * @generated
	 */
	ComponentsTransformation createComponentsTransformation();
