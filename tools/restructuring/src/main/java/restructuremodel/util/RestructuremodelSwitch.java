...
public class RestructuremodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RestructuremodelPackage.COMPONENTS_TRANSFORMATION: {
				ComponentsTransformation componentsTransformation = (ComponentsTransformation)theEObject;
				T result = caseComponentsTransformation(componentsTransformation);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Components Transformation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Components Transformation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComponentsTransformation(ComponentsTransformation object) {
		return null;
	}
