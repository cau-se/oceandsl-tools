...
public class RestructuremodelFactoryImpl extends EFactoryImpl implements RestructuremodelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RestructuremodelPackage.COMPONENTS_TRANSFORMATION: return createComponentsTransformation();
	 ...
	 * @generated
	 */
	public ComponentsTransformation createComponentsTransformation() {
		ComponentsTransformationImpl componentsTransformation = new ComponentsTransformationImpl();
		return componentsTransformation;
	}
