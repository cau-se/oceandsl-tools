 ...
 * </p>
 * <ul>
 *   <li>{@link restructuremodel.impl.MergeComponentImpl#getMergeGoalComponent <em>Merge Goal Component</em>}</li>
 *   <li>{@link restructuremodel.impl.MergeComponentImpl#getComponentName <em>Component Name</em>}</li>
 *   <li>{@link restructuremodel.impl.MergeComponentImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link restructuremodel.impl.MergeComponentImpl#getDeleteTransformation <em>Delete Transformation</em>}</li>
 *   <li>{@link restructuremodel.impl.MergeComponentImpl#getOperationToMove <em>Operation To Move</em>}</li>
 * </ul>
 *
 * @generated
 */
