...
public class RestructuremodelPackageImpl extends EPackageImpl implements RestructuremodelPackage {
	 ...
	 * @generated
	 */
	private EClass componentsTransformationEClass = null;
	 ...
	 * @see restructuremodel.RestructuremodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getComponentsTransformation() {
		return componentsTransformationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getComponentsTransformation_Transformations() {
		return (EReference)componentsTransformationEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		componentsTransformationEClass = createEClass(COMPONENTS_TRANSFORMATION);
		createEReference(componentsTransformationEClass, COMPONENTS_TRANSFORMATION__TRANSFORMATIONS);
	...
	public void initializePackageContents() {
		...
		initEClass(componentsTransformationEClass, ComponentsTransformation.class, "ComponentsTransformation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComponentsTransformation_Transformations(), this.getAbstractTransformationStep(), null, "transformations", null, 1, -1, ComponentsTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
